    ...
    return (
        <>
            ...
            <div className="flex flex-row flex-nowrap gap-x-4 md:gap-x-8 overflow-x-auto ">
                <AddCertificationRecord  isOpen={isOpenNewCertificateModal} onClick={()=>setIsOpenNewCertificateModal(true)} onClickSave={(e)=>submitNewCertificate(e)} />
                {
            ...
            <AddCertificationRecordModal isOpen={isOpenNewCertificateModal} onClickCloseModal={()=>setIsOpenNewCertificateModal(false)} onClickSave={(e)=>{submitNewCertificate(e)}} />
